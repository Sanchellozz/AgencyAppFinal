...
namespace AgencyApp.Controllers
{
    ...
    public class DictionariesController : Controller
    {
        ...
        public DictionariesController(AgencyDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Text,Price")] Dictionary dictionary)
        {
        ...
        [ValidateAntiForgeryToken]
        [Authorize(Roles = "admin")]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Text,Price")] Dictionary dictionary)
        {
            if (id != dictionary.Id)
            {
                return NotFound();
